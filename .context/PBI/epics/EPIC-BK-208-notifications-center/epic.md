...
| --- | ----- | ------ | -------- | ------ |
| [BK-209](https://jira.upexgalaxy.com/browse/BK-209) | Notifications | View an inbox of workspace events | 13 | Medium | Ready For Dev |
| [BK-211](https://jira.upexgalaxy.com/browse/BK-211) | Notifications | Get notified when a run finishes or is aborted | 5 | Medium | Ready For Dev |
| [BK-212](https://jira.upexgalaxy.com/browse/BK-212) | Notifications | Get notified on bug assignment and status changes | 8 | Medium | Ready For Dev |
| [BK-213](https://jira.upexgalaxy.com/browse/BK-213) | Notifications | Configure notification preferences per event type | 3 | Medium | Ready For Dev |
